...
import RelsPage from "../components/RelsPage/RelsPage";
import SingleRelsPage from "../components/RelsPage/SingleRelsPage";
import CategPage from "../components/CategPage/CategPage";
import SingleCategPage from "../components/CategPage/SingleCategPage";
// ~cb-add-import~
        ...
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <MainLayout>
                <Switch>
                    ...
                    <Route path="/rels" component={RelsPage} exact />
                    <Route path="/rels/:singleRelsId" component={SingleRelsPage} exact />
                    <Route path="/categ" component={CategPage} exact />
                    <Route path="/categ/:singleCategId" component={SingleCategPage} exact />
                    {/* ~cb-add-route~ */}
